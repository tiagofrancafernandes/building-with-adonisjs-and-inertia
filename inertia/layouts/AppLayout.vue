            ...
            <div class="flex flex-1 items-center justify-end">
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem :as="Link" href="/settings/profile">Profile Settings</DropdownMenuItem>
                        <DropdownMenuItem :as="Link" href="/settings/account">Account Settings</DropdownMenuItem>
                        <DropdownMenuItem :as="Link" href="/settings/organization">Organization Settings</DropdownMenuItem>
                        <DropdownMenuSeparator />
