...
<template>
    <DropdownMenu>
        ...
        <DropdownMenuContent>
            ...
            <DropdownMenuItem @click="destroy.open(organization)">Delete {{ organization.name }}</DropdownMenuItem>
    ...
    >
        ...
        organization? All data associated with this organization, including courses and lessons, will be deleted forever.
    </ConfirmDestroyDialog>
</template>
