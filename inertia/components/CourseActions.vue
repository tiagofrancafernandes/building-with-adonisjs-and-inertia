...
<template>
    ...
    <ConfirmDestroyDialog v-model:open="destroy.isOpen" title="Delete Course?" :action-href="`/courses/${destroy.resource?.id}`">
        Are you sure you'd like to delete your
        <strong>{{ destroy.resource?.name }}</strong>
        course? All data associated with this course, including moduels and lessons, will be deleted forever.
