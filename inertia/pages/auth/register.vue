...
<template>
    ...
    <form class="grid gap-3" @submit.prevent="form.post('/register', { onSuccess: () => form.reset() })">
        <FormInput label="Full Name" v-model="form.fullName" :error="form.errors.fullName" :disabled="form.processing" />
