    ...
    <div class="w-full max-w-2xl mx-auto bg-background rounded-xl p-4">
        ...
        >
            <div v-if="destroy.resource?.meta.courses_count != 0">
                ...
                {{ destroy.resource?.meta.courses_count }} courses &amp; {{ destroy.resource?.meta.lessons_count }} lessons using
            ...
            <div v-else>
                ...
                difficulty? No courses are currently using this access level
            </div>
        </ConfirmDestroyDialog>
    </div>
</template>
