...
export default class OrganizationInviteDto extends BaseModelDto {
    ...
    constructor(organizationInvite?: OrganizationInvite) {
        ...
        this.invitedByUser = organizationInvite.invitedByUser && new UserDto(organizationInvite.invitedByUser);
        this.canceledByUser = organizationInvite.canceledByUser && new UserDto(organizationInvite.canceledByUser);
